...
export default function FoodItemCard({ item, showFullInfo = false }: FoodItemCardProps) {
  ...
  const getFoodImage = (foodName: string): string => {
    const foodImages: { [key: string]: string } = {
      ...
      "にんにく": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ccircle cx='50' cy='55' r='25' fill='%23F5F5DC'/%3E%3Cpath d='M50 30 Q45 35 50 40 Q55 35 50 30' fill='%23E6E6CD'/%3E%3Cpath d='M40 45 Q35 50 40 55' fill='%23E6E6CD'/%3E%3Cpath d='M60 45 Q65 50 60 55' fill='%23E6E6CD'/%3E%3C/svg%3E",
      ...
      // 肉類
      "豚ミンチ": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Cpath d='M30 40 Q40 35 50 40 Q60 35 70 40 Q70 60 50 65 Q30 60 30 40' fill='%23E91E63'/%3E%3Ccircle cx='40' cy='45' r='3' fill='%23FFFFFF'/%3E%3Ccircle cx='60' cy='45' r='3' fill='%23FFFFFF'/%3E%3C/svg%3E",
      "国産豚ミンチ": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Cpath d='M30 40 Q40 35 50 40 Q60 35 70 40 Q70 60 50 65 Q30 60 30 40' fill='%23E91E63'/%3E%3Ccircle cx='40' cy='45' r='3' fill='%23FFFFFF'/%3E%3Ccircle cx='60' cy='45' r='3' fill='%23FFFFFF'/%3E%3C/svg%3E",
